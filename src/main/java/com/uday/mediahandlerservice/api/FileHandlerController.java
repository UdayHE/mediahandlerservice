package com.uday.mediahandlerservice.api;
...
public class FileHandlerController {
    ...
    @GetMapping
    public ResponseEntity<ByteArrayResource> downloadFile(@RequestParam(value = "file_name") String fileName) throws IOException {
